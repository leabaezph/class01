...
function imprimirFilas()
    ...
    datos.forEach((item, i) => {
      salida=salida+"<div class='card'><div class='card-header'>"+item[0]+","+item[1]+"</div><p><b>Id</b>:   "+i+"</p><p><b>Fecha de nacimiento:</b>    "+item[2]+"</p><p><button type='button' class='btEditar  btn btn-warning' data-id='"+i+"'>Editar</button> <button type='button' class='btBorrar btn btn-danger' data-id='"+i+"'>Borrar</button> </p></p>"
    });
